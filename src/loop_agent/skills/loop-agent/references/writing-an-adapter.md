...
> [`ModelLadder`](https://github.com/happy-ryo/loop-agent/blob/main/src/loop_agent/adapters/model_ladder.py), which
...
structural contract [`ActResult`](https://github.com/happy-ryo/loop-agent/blob/main/src/loop_agent/adapters/base.py)
...
dataclass [`ActResultBase`](https://github.com/happy-ryo/loop-agent/blob/main/src/loop_agent/adapters/base.py). All fields
...
1. **Common harness (cross-adapter contract)** -
   ...
   `AdapterSpec` in
   [`tests/adapters/conftest.py`](https://github.com/happy-ryo/loop-agent/blob/main/tests/adapters/conftest.py). The
