...
4. **Model escalation is orthogonal**. If the difficulty comes from a weaker model lacking capability, the [ModelLadder pattern](./adapters/README.md) (escalating to a stronger model) helps more than Reflexion. The two can be combined as a two-stage defense: lessons plus model escalation.
...
For details, see [docs/reflexion.md](./reflexion.md).
